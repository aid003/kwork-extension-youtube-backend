...
/**
 * Отвечает на вопрос по видео-транскрипту.
 * • language — язык ответа (en / ru …)
 * • detail   — уровень детализации ответа (concise / standard / detailed)
 * При отсутствии данных в источнике выводит «ИСТОЧНИК НЕ СОДЕРЖИТ ОТВЕТА».
 */
export async function answerQuestion(
  ...
  /* ---------- logging (request) ---------- */
  console.log("───────────────────────────────────────");
  console.log("[Gemini] answerQuestion()");
  console.log("• Language :", language);
  console.log("• Detail   :", detail);
  console.log("• Q.len    :", question.length);
